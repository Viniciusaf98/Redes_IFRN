...
# Exibe as opções de esquemas táticos em formato de tabela
...
try:
    with open(f'cartola_selecao_{ano_informado}.json', 'w') as outfile:
        json.dump(cartola_selecao, outfile, indent=4)
except IOError:
    print("Erro ao salvar o arquivo JSON.")
    exit()

# Exibindo a seleção final em formato de tabela
